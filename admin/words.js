...
systemDictionary = {
    "bestway adapter settings": {
        en: "Adapter settings for bestway",
        de: "Adaptereinstellungen für bestway",
        ru: "Настройки адаптера для bestway",
        pt: "Configurações do adaptador para bestway",
        nl: "Adapterinstellingen voor bestway",
        fr: "Paramètres d'adaptateur pour bestway",
        it: "Impostazioni dell'adattatore per bestway",
        es: "Ajustes del adaptador para bestway",
        pl: "Ustawienia adaptera dla bestway",
        "zh-cn": "bestway的适配器设置",
    },
    "App Email": {
        en: "App Email",
